 ...
 * 
 * Permite búsquedas combinadas por cualquier campo:
 *  - Campos generales de texto (búsqueda parcial case-insensitive): ?campo=valor
 *    Ejemplo: materias?nombre_materia=biolog&contenidos_minimos=evolución
 * 
 *  - Campos depto, area y orientacion (búsqueda exacta case-insensitive): ?campo=valor
 *    Ejemplo: materias?depto=ECOLOGÍA&orientacion=EVOLUCIÓN
 *    Estos campos siempre usan coincidencia exacta, no parcial.
 * 
